#!/bin/bash
#
# ZeroCode App Restart Script
# Usage: ./restart.sh [options]
#
# Options:
#   --help, -h     Show help information
#   --logs, -l     Show logs after restarting
#   --port=XXXX    Specify custom port (default: 3004)
#
...
do
    case $arg in
        --help|-h)
            ...
            echo "  --logs, -l     Show logs after restarting"
...
start_app() {
    ...
    if ! check_port_in_use; then
        ...
        echo "🚀 $APP_NAME is now running at http://localhost:$CUSTOM_PORT"
    fi
}
